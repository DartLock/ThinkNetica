defmodule Part10DockerWeb.UserControllerTest do
  use Part10DockerWeb.ConnCase

  import Part10Docker.AccountsFixtures

  @create_attrs %{email: "email_1@mail.com", name: "some name"}
